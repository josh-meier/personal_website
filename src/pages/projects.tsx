...
export default function Projects(){
  return(
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <Image unoptimized className="h-auto w-11/12" width={3000} height={1000} src="/figma_prototype_1.jpg" alt="Screenshot of figma design displaying a search functionality for your dorm, then
